...
package SDL.Events.Keyboards is
   ...
   Code_Caps_Lock                   : constant Key_Codes := 16#20000039#;
   Code_F1                          : constant Key_Codes := 16#2000003A#;
   Code_F2                          : constant Key_Codes := 16#2000003B#;
   Code_F3                          : constant Key_Codes := 16#2000003C#;
   Code_F4                          : constant Key_Codes := 16#2000003D#;
   Code_F5                          : constant Key_Codes := 16#2000003E#;
   Code_F6                          : constant Key_Codes := 16#2000003F#;
   Code_F7                          : constant Key_Codes := 16#20000040#;
   Code_F8                          : constant Key_Codes := 16#20000041#;
   Code_F9                          : constant Key_Codes := 16#20000042#;
   Code_F10                         : constant Key_Codes := 16#20000043#;
   Code_F11                         : constant Key_Codes := 16#20000044#;
   Code_F12                         : constant Key_Codes := 16#20000045#;

   Code_Print_Screen                : constant Key_Codes := 16#20000046#;
   Code_Scroll_Lock                 : constant Key_Codes := 16#20000047#;
   Code_Pause                       : constant Key_Codes := 16#20000048#;
   Code_Insert                      : constant Key_Codes := 16#20000049#;
   Code_Home                        : constant Key_Codes := 16#2000004A#;
   Code_Page_Up                     : constant Key_Codes := 16#2000004B#;
   Code_Delete                      : constant Key_Codes :=       16#7F#;
   Code_End                         : constant Key_Codes := 16#2000004D#;
   Code_Page_Down                   : constant Key_Codes := 16#2000004E#;
   Code_Right                       : constant Key_Codes := 16#2000004F#;
   Code_Left                        : constant Key_Codes := 16#20000050#;
   Code_Down                        : constant Key_Codes := 16#20000051#;
   Code_Up                          : constant Key_Codes := 16#20000052#;

   Code_Num_Lock_Clear              : constant Key_Codes := 16#20000053#;
   Code_KP_Divide                   : constant Key_Codes := 16#20000054#;
   Code_KP_Multiply                 : constant Key_Codes := 16#20000055#;
   Code_KP_Minus                    : constant Key_Codes := 16#20000056#;
   Code_KP_Plus                     : constant Key_Codes := 16#20000057#;
   Code_KP_Enter                    : constant Key_Codes := 16#20000058#;
   Code_KP_1                        : constant Key_Codes := 16#20000059#;
   Code_KP_2                        : constant Key_Codes := 16#2000005A#;
   Code_KP_3                        : constant Key_Codes := 16#2000005B#;
   Code_KP_4                        : constant Key_Codes := 16#2000005C#;
   Code_KP_5                        : constant Key_Codes := 16#2000005D#;
   Code_KP_6                        : constant Key_Codes := 16#2000005E#;
   Code_KP_7                        : constant Key_Codes := 16#2000005F#;
   Code_KP_8                        : constant Key_Codes := 16#20000060#;
   Code_KP_9                        : constant Key_Codes := 16#20000061#;
   Code_KP_0                        : constant Key_Codes := 16#20000062#;
   Code_KP_Period                   : constant Key_Codes := 16#20000063#;

   Code_Application                 : constant Key_Codes := 16#20000065#;
   Code_Power                       : constant Key_Codes := 16#20000066#;
   Code_KP_Equals                   : constant Key_Codes := 16#20000067#;
   Code_F13                         : constant Key_Codes := 16#20000068#;
   Code_F14                         : constant Key_Codes := 16#20000069#;
   Code_F15                         : constant Key_Codes := 16#2000006A#;
   Code_F16                         : constant Key_Codes := 16#2000006B#;
   Code_F17                         : constant Key_Codes := 16#2000006C#;
   Code_F18                         : constant Key_Codes := 16#2000006D#;
   Code_F19                         : constant Key_Codes := 16#2000006E#;
   Code_F20                         : constant Key_Codes := 16#2000006F#;
   Code_F21                         : constant Key_Codes := 16#20000070#;
   Code_F22                         : constant Key_Codes := 16#20000071#;
   Code_F23                         : constant Key_Codes := 16#20000072#;
   Code_F24                         : constant Key_Codes := 16#20000073#;
   Code_Execute                     : constant Key_Codes := 16#20000074#;
   Code_Help                        : constant Key_Codes := 16#20000075#;
   Code_Menu                        : constant Key_Codes := 16#20000076#;
   Code_Select                      : constant Key_Codes := 16#20000077#;
   Code_Stop                        : constant Key_Codes := 16#20000078#;
   Code_Again                       : constant Key_Codes := 16#20000079#;
   Code_Undo                        : constant Key_Codes := 16#2000007A#;
   Code_Cut                         : constant Key_Codes := 16#2000007B#;
   Code_Copy                        : constant Key_Codes := 16#2000007C#;
   Code_Paste                       : constant Key_Codes := 16#2000007D#;
   Code_Find                        : constant Key_Codes := 16#2000007E#;
   Code_Mute                        : constant Key_Codes := 16#2000007F#;
   Code_Volume_Up                   : constant Key_Codes := 16#20000080#;
   Code_Volume_Down                 : constant Key_Codes := 16#20000081#;
   Code_KP_Comma                    : constant Key_Codes := 16#20000085#;
   Code_KP_Equals_AS400             : constant Key_Codes := 16#20000086#;

   Code_Alt_Erase                   : constant Key_Codes := 16#20000099#;
   Code_Sys_Req                     : constant Key_Codes := 16#2000009A#;
   Code_Cancel                      : constant Key_Codes := 16#2000009B#;
   Code_Clear                       : constant Key_Codes := 16#2000009C#;
   Code_Prior                       : constant Key_Codes := 16#2000009D#;
   Code_Return_2                    : constant Key_Codes := 16#2000009E#;
   Code_Separator                   : constant Key_Codes := 16#2000009F#;
   Code_Out                         : constant Key_Codes := 16#200000A0#;
   Code_Oper                        : constant Key_Codes := 16#200000A1#;
   Code_Clear_Again                 : constant Key_Codes := 16#200000A2#;
   Code_CR_Sel                      : constant Key_Codes := 16#200000A3#;
   Code_Ex_Sel                      : constant Key_Codes := 16#200000A4#;

   Code_KP_00                       : constant Key_Codes := 16#200000B0#;
   Code_KP_000                      : constant Key_Codes := 16#200000B1#;
   Code_Thousands_Separator         : constant Key_Codes := 16#200000B2#;
   Code_Decimal_Separator           : constant Key_Codes := 16#200000B3#;
   Code_Currency_Unit               : constant Key_Codes := 16#200000B4#;
   Code_Currency_Subunit            : constant Key_Codes := 16#200000B5#;
   Code_KP_Left_Parenthesis         : constant Key_Codes := 16#200000B6#;
   Code_KP_Right_Parentheesis       : constant Key_Codes := 16#200000B7#;
   Code_KP_Left_Brace               : constant Key_Codes := 16#200000B8#;
   Code_KP_Right_Brace              : constant Key_Codes := 16#200000B9#;
   Code_KP_Tab                      : constant Key_Codes := 16#200000BA#;
   Code_KP_Backspace                : constant Key_Codes := 16#200000BB#;
   Code_KP_A                        : constant Key_Codes := 16#200000BC#;
   Code_KP_B                        : constant Key_Codes := 16#200000BD#;
   Code_KP_C                        : constant Key_Codes := 16#200000BE#;
   Code_KP_D                        : constant Key_Codes := 16#200000BF#;
   Code_KP_E                        : constant Key_Codes := 16#200000C0#;
   Code_KP_F                        : constant Key_Codes := 16#200000C1#;
   Code_KP_XOR                      : constant Key_Codes := 16#200000C2#;
   Code_KP_Power                    : constant Key_Codes := 16#200000C3#;
   Code_KP_Percent                  : constant Key_Codes := 16#200000C4#;
   Code_KP_Less                     : constant Key_Codes := 16#200000C5#;
   Code_KP_Greater                  : constant Key_Codes := 16#200000C6#;
   Code_KP_Ampersand                : constant Key_Codes := 16#200000C7#;
   Code_KP_Double_Ampersand         : constant Key_Codes := 16#200000C8#;
   Code_KP_Vertical_Bar             : constant Key_Codes := 16#200000C9#;
   Code_KP_Double_Vertical_Bar      : constant Key_Codes := 16#200000CA#;
   Code_KP_Colon                    : constant Key_Codes := 16#200000CB#;
   Code_KP_Hash                     : constant Key_Codes := 16#200000CC#;
   Code_KP_Space                    : constant Key_Codes := 16#200000CD#;
   Code_KP_At                       : constant Key_Codes := 16#200000CE#;
   Code_KP_Exclamation              : constant Key_Codes := 16#200000CF#;
   Code_KP_Memory_Store             : constant Key_Codes := 16#200000D0#;
   Code_KP_Memory_Recall            : constant Key_Codes := 16#200000D1#;
   Code_KP_Memory_Clear             : constant Key_Codes := 16#200000D2#;
   Code_KP_Memory_Add               : constant Key_Codes := 16#200000D3#;
   Code_KP_Memory_Subtract          : constant Key_Codes := 16#200000D4#;
   Code_KP_Memory_Multiply          : constant Key_Codes := 16#200000D5#;
   Code_KP_Memory_Divide            : constant Key_Codes := 16#200000D6#;
   Code_KP_Plus_Minus               : constant Key_Codes := 16#200000D7#;
   Code_KP_Clear                    : constant Key_Codes := 16#200000D8#;
   Code_KP_Clear_Entry              : constant Key_Codes := 16#200000D9#;
   Code_KP_Binary                   : constant Key_Codes := 16#200000DA#;
   Code_KP_Octal                    : constant Key_Codes := 16#200000DB#;
   Code_KP_Decimal                  : constant Key_Codes := 16#200000DC#;
   Code_KP_Hexadecimal              : constant Key_Codes := 16#200000DD#;

   Code_Left_Control                : constant Key_Codes := 16#200000E0#;
   Code_Left_Shift                  : constant Key_Codes := 16#200000E1#;
   Code_Left_Alt                    : constant Key_Codes := 16#200000E2#;
   Code_Left_GUI                    : constant Key_Codes := 16#200000E3#;
   Code_Right_Control               : constant Key_Codes := 16#200000E4#;
   Code_Right_Shift                 : constant Key_Codes := 16#200000E5#;
   Code_Right_Alt                   : constant Key_Codes := 16#200000E6#;
   Code_Right_GUI                   : constant Key_Codes := 16#200000E7#;

   Code_Mode                        : constant Key_Codes := 16#20000101#;

   Code_Audio_Next                  : constant Key_Codes := 16#20000102#;
   Code_Audio_Previous              : constant Key_Codes := 16#20000103#;
   Code_Audio_Stop                  : constant Key_Codes := 16#20000104#;
   Code_Audio_Play                  : constant Key_Codes := 16#20000105#;
   Code_Audio_Mute                  : constant Key_Codes := 16#20000106#;
   Code_Media_Select                : constant Key_Codes := 16#20000107#;
   Code_WWW                         : constant Key_Codes := 16#20000108#;
   Code_Mail                        : constant Key_Codes := 16#20000109#;
   Code_Calculator                  : constant Key_Codes := 16#2000010A#;
   Code_Computer                    : constant Key_Codes := 16#2000010B#;
   Code_AC_Search                   : constant Key_Codes := 16#2000010C#;
   Code_AC_Home                     : constant Key_Codes := 16#2000010D#;
   Code_AC_Back                     : constant Key_Codes := 16#2000010E#;
   Code_AC_Forward                  : constant Key_Codes := 16#2000010F#;
   Code_AC_Stop                     : constant Key_Codes := 16#20000110#;
   Code_AC_Refresh                  : constant Key_Codes := 16#20000111#;
   Code_AC_Bookmarks                : constant Key_Codes := 16#20000112#;

   Code_Brightness_Down             : constant Key_Codes := 16#20000114#;
   Code_Brightness_Up               : constant Key_Codes := 16#20000113#;
   Code_Display_Switch              : constant Key_Codes := 16#20000115#;
   Code_Illumination_Toggle         : constant Key_Codes := 16#20000116#;
   Code_Illumination_Down           : constant Key_Codes := 16#20000117#;
   Code_Illumination_Up             : constant Key_Codes := 16#20000118#;
   Code_Eject                       : constant Key_Codes := 16#20000119#;
   Code_Sleep                       : constant Key_Codes := 16#2000011A#;
